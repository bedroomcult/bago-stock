...
CREATE TABLE products (
    id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    qr_code VARCHAR(255) UNIQUE NOT NULL, -- The QR code identifier
    category VARCHAR(100) NOT NULL,
    product_name VARCHAR(255) NOT NULL,
    color VARCHAR(50) DEFAULT '#3B82F6', -- Hex color code for visual identification (copied from template)
    status VARCHAR(50) NOT NULL DEFAULT 'TOKO', -- 'TOKO', 'GUDANG KEPATHIAN', 'GUDANG NGUNUT', 'TERJUAL'
